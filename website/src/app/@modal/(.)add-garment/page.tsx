...
export default function UploadModal() {
  ...
  return (
      <div className='text-white h-150 w-100 fixed left-[50%] top-[50%] translate-[-50%] cursor-pointer p-8 bg-zinc-800'>
        <button className="absolute top-0 right-0" onClick={() => {router.back()}}>Back</button>
      <h1>Add Garment</h1>
